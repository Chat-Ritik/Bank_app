...
const SampleRewards = () => {
  ...
  const nextMilestone = milestones.find((milestone) => milestone.value > progress);

  return (
    <div className="max-w-md mx-auto mt-8">
      <h2 className="text-2xl font-semibold mb-4 text-gray-500">Your Rewards Progress</h2>
      ...
      <div className="mt-4">
        <p className="text-gray-600">
          {nextMilestone
            ? `Earn ${nextMilestone.value - progress}% more to unlock ${nextMilestone.description}`
